...
exports.updateLastPathnameIfNeeded = undefined;
...
var updateLastPathnameIfNeeded = exports.updateLastPathnameIfNeeded = function updateLastPathnameIfNeeded(newLoc, _ref) {
...
var createActionIfNeeded = function createActionIfNeeded(loc, syncObject, _ref2) {
  ...
  if (loc.search !== syncObject.lastQueryString) {
    store.dispatch(syncObject.actionCreator(syncObject.parsed ? _qs2.default.parse(loc.search) : loc.search));
...
var updateStateIfNeeded = function updateStateIfNeeded(syncObject, _ref3) {
  ...
  var newQueryString = syncObject.selector(state);
